...
-- DO NOTHING on conflict so migrate.sh never overwrites a real hash
INSERT INTO admin_employees (email, password_hash, full_name, role, permissions, is_active)
VALUES (
    'garbaabdullahi344@gmail.com',
    '$argon2id$v=19$m=65536,t=3,p=4$yCXEwAJNeo2SDJrKjpu0AA$QpepnpvZF9hoO4JZFChVu02OHi/bVFvlkSsphJ2lj/A',
    'Garba Abdullahi',
    'SUPER_ADMIN',
    '["*"]'::jsonb,
    true
